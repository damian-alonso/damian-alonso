...
- **[Overpass - Gimnasio de Escalada](https://github.com/damian-alonso/0verpass)**
...
- **[Sistema de Tickets - Soporte Técnico Área de Salud](https://github.com/damian-alonso/sistema-tickets-salud)**
 
  <a href="https://damian-alonso.github.io/sistema-tickets-salud/" target="_blank">
...
tareas, control de estados de los tickets, autenticación básica de técnicos y generación dinámica de reportes.
   ...
   * **Base de Datos:** MySQL 8 (Persistencia de tickets y usuarios).
   * **Infraestructura:** Docker, Docker Compose (Contenedorización de la API y la base de datos).
   * **Generación de Reportes:** Apache POI, Apache PDFBox (Exportación de listados a formatos Excel y PDF).

   **[🔗 Ver Proyecto en Vivo](https://damian-alonso.github.io/sistema-tickets-salud/)**
